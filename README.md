...
[**Binary to Decimal and Back Converter**](https://github.com/mang0/Projects/blob/master/Numbers/BinaryConverter.py) – Develop a converter to convert a decimal number to binary or a binary number to its decimal equivalent.
...
[**Vigenere / Vernam / Caesar Ciphers**](https://github.com/mang0/Projects/blob/master/Text/caeser.py) – Functions for encrypting and decrypting data messages. Then send them to a friend.
